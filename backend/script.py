...
model = load_model("UNET_BASE_MAXEPOCHS.h5", custom_objects={
...
def save(nuclei_count=None, adj_nuclei_count=None):
    ...
    if not(nuclei_count and adj_nuclei_count and pixels):
        nuclei_count, adj_nuclei_count, pixels = connectedCompenets()
...
while True:
    ...
    # _, frame = cap.read()
    frame = cv2.imread("UNET/data-science-bowl-2018/stage1_train/0e4c2e2780de7ec4312f0efcd86b07c3738d21df30bb4643659962b4da5505a3/images/0e4c2e2780de7ec4312f0efcd86b07c3738d21df30bb4643659962b4da5505a3.png")
    ...
    if key == (ord('q')):
        ...
        if choice == 's':
            save(nuclei_count, adj_nuclei_count)
