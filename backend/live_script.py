...
def save(nuclei_count, adj_nuclei_count, original_image):
...
while True:
    ...
    _, frame = cap.read()
    # frame = cv2.imread("stage1_train/0b0d577159f0d6c266f360f7b8dfde46e16fa665138bf577ec3c6f9c70c0cd1e/images/0b0d577159f0d6c266f360f7b8dfde46e16fa665138bf577ec3c6f9c70c0cd1e.png")
    ...
    item = "Press 'S' to save current image  Press 'F' to freeze and graph"
    ...
    if key == (ord('q')):
        ...
        choice = input("Enter 's' to save image, else just press 'Enter': ")
        if choice == 's':
